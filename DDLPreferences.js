...
define(function (require, exports, module) {
    ...
    var ddlPreferences = {
        ...
        "ddl.gen.comment":{
            text: "Comment",
            description: "Generator with comment",
            type: "Check",
            default: true
        },
        "ddl.gen.autoincrement":{
            text:"AutoIncrement",
            description: "Generator Primary key with auto_increment",
            type : "Check",
            default: true
        },
        "ddl.gen.dbms": {
    ...
    function getGenOptions() {
        return {
            ...
            comment          : PreferenceManager.get("ddl.gen.comment"),
            autoIncrement    : PreferenceManager.get("ddl.gen.autoincrement")
        };
    }
